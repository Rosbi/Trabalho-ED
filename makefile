...
siguel: main.o lista.o query.o svg.o formasBase.o hidrante.o quadra.o semaforo.o torre.o geometria.o predio.o
	gcc -o siguel main.o formasBase.o lista.o query.o svg.o hidrante.o quadra.o semaforo.o torre.o geometria.o predio.o -lm
